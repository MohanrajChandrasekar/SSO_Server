...
const { genJwtToken, genRefreshToekn } = require("./jwt_helper");
...
const verifySsoToken = async (req, res, next) => {
  ...
  const refreshToken = await genRefreshToekn(payload);
